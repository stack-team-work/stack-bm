...
type AdHandler struct {
	service *biliTplSvc.AdService
}

func NewAdHandler() *AdHandler {
	return &AdHandler{service: biliTplSvc.NewAdService()}
}

// Register 注册广告模板路由（挂载于 /bili/v1 组）
func (h *AdHandler) Register(rg gin.IRouter) {
	prefix := "/template/ad/"
...
func (h *AdHandler) GetList(c *gin.Context) {
	var req listRequest
...
func (h *AdHandler) Copy(c *gin.Context) {
	var req struct {
		ID           string `json:"id"`
