...
func NewAudienceTemplateService() *AudienceTemplateService {
	return &AudienceTemplateService{repo: ksRepo.NewAudienceTemplateRepository()}
}

func (s *AudienceTemplateService) Create(doc *ksModel.AudienceTemplate, adminID int) error {
	if doc.TemplateName == "" {
...
func (s *AudienceTemplateService) FindPage(page, size int, keyword string) ([]ksModel.AudienceTemplate, int64, error) {
	if page < 1 {
		page = 1
	}
	if size < 1 {
...
func (s *AudienceTemplateService) FindByID(id string) (*ksModel.AudienceTemplate, error) {
	return s.repo.FindByID(id)
}

func (s *AudienceTemplateService) Update(id string, doc *ksModel.AudienceTemplate) error {
