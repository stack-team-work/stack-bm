...
func NewGameTagRepository() *GameTagRepository {
	return &GameTagRepository{db: database.DBApi}
}

func (r *GameTagRepository) Create(tag *game.GameTag) error { return r.db.Create(tag).Error }
...
func (r *GameTagRepository) Update(tag *game.GameTag) error { return r.db.Save(tag).Error }
...
func NewGameVariableRepository() *GameVariableRepository {
	return &GameVariableRepository{db: database.DBApi}
}

func (r *GameVariableRepository) Create(v *game.GameVariable) error { return r.db.Create(v).Error }
...
func (r *GameVariableRepository) Update(v *game.GameVariable) error { return r.db.Save(v).Error }
