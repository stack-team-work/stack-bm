...
func (r *AdTemplateRepository) col() *mongo.Collection { return collection("bili_ad_template") }

func (r *AdTemplateRepository) Create(doc *biliModel.AdTemplate) error {
...
func (r *AdTemplateRepository) FindByID(id string) (*biliModel.AdTemplate, error) {
	if database.ChannelDB == nil {
...
func (r *AdTemplateRepository) FindPage(page, size int, keyword string) ([]biliModel.AdTemplate, int64, error) {
	if database.ChannelDB == nil {
...
func (r *AdTemplateRepository) Update(doc *biliModel.AdTemplate) error {
	if database.ChannelDB == nil {
		return errMongoUnavailable
	}
...
func (r *AdTemplateRepository) ListAll() ([]biliModel.AdTemplate, error) {
	if database.ChannelDB == nil {
		return nil, errMongoUnavailable
	}
	ctx := context.Background()
