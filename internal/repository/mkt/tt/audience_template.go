...
func NewAudienceTemplateRepository() *AudienceTemplateRepository {
	return &AudienceTemplateRepository{}
}

func (r *AudienceTemplateRepository) col() *mongo.Collection {
	return collection("tt_audience_template")
}

func (r *AudienceTemplateRepository) Create(doc *ttModel.AudienceTemplate) error {
...
func (r *AudienceTemplateRepository) FindByID(id string) (*ttModel.AudienceTemplate, error) {
	if database.ChannelDB == nil {
	...
	var doc ttModel.AudienceTemplate
...
func (r *AudienceTemplateRepository) FindPage(page, size int, keyword string) ([]ttModel.AudienceTemplate, int64, error) {
	if database.ChannelDB == nil {
	...
	var list []ttModel.AudienceTemplate
...
func (r *AudienceTemplateRepository) Update(doc *ttModel.AudienceTemplate) error {
	if database.ChannelDB == nil {
		return errMongoUnavailable
	}
...
func (r *AudienceTemplateRepository) ListAll() ([]ttModel.AudienceTemplate, error) {
	if database.ChannelDB == nil {
		return nil, errMongoUnavailable
	}
	ctx := context.Background()
