...
func (r *AdTemplateRepository) col() *mongo.Collection { return collection("ks_ad_template") }

func (r *AdTemplateRepository) Create(doc *ksModel.AdTemplate) error {
...
func (r *AdTemplateRepository) FindByID(id string) (*ksModel.AdTemplate, error) {
	if database.ChannelDB == nil {
...
func (r *AdTemplateRepository) FindPage(page, size int, keyword string) ([]ksModel.AdTemplate, int64, error) {
	if database.ChannelDB == nil {
...
func (r *AdTemplateRepository) Update(doc *ksModel.AdTemplate) error {
	if database.ChannelDB == nil {
		return errMongoUnavailable
	}
...
func (r *AdTemplateRepository) ListAll() ([]ksModel.AdTemplate, error) {
	if database.ChannelDB == nil {
		return nil, errMongoUnavailable
	}
	ctx := context.Background()
