<template>
  <div>
    ...
    <n-modal v-model:show="showModal" :title="isEdit ? '编辑CP' : '新增CP'" preset="card" style="width: 560px" :mask-closable="false">
      <n-form ref="formRef" :model="formData" :rules="rules" label-placement="left" label-width="100">
        <n-grid :cols="2" :x-gap="16">
          <n-form-item-gi path="name" label="CP名称">
          ...
          <n-form-item-gi path="phone" label="电话">
            <n-input v-model:value="formData.phone" placeholder="请输入电话" />
          </n-form-item-gi>
          <n-form-item-gi path="addr" label="地址">
...
import { getGameCpList, createGameCp, updateGameCp, deleteGameCp } from '../../../api/sdk/game'
import { formatTime } from '../../../utils/format'
import { CreateOutline, TrashOutline } from '@vicons/ionicons5'

const { loading, tableData, pagination, search, handlePageChange, handlePageSizeChange } = useTable(getGameCpList)
