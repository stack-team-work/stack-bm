...
import { getGameList, createGame, updateGame, deleteGame } from '../../../api/sdk/game'
import { formatTime } from '../../../utils/format'
import TableActions from '../../../components/TableActions.vue'

const { loading, tableData, pagination, search, handlePageChange, handlePageSizeChange } = useTable(getGameList)
