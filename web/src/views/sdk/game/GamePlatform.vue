<template>
  <div>
    ...
    <n-modal v-model:show="showModal" :title="isEdit ? '编辑平台' : '新增平台'" preset="card" style="width: 560px" :mask-closable="false">
...
import { getGamePlatformList, createGamePlatform, updateGamePlatform, deleteGamePlatform } from '../../../api/sdk/game'
