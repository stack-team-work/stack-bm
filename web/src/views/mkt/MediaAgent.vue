<template>
  <div>
    ...
    <n-modal v-model:show="showModal" :title="isEdit ? '编辑代理' : '新增代理'" preset="card" style="width: 500px" :mask-closable="false">
      <n-form ref="formRef" :model="formData" :rules="rules">
        <n-form-item path="subject_id" label="所属主体">
          <n-select v-model:value="formData.subject_id" :options="subjectOptions" placeholder="请选择主体" clearable />
        </n-form-item>
        <n-form-item path="name" label="代理名称">
          <n-input v-model:value="formData.name" placeholder="请输入代理名称" />
        </n-form-item>
        <n-form-item path="mark" label="代理标识">
